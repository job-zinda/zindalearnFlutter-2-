...
//     final filteredCourses = provider.courses.where((course) {
//       // First evaluate backend category type rules
...
//       // Then verify if it contains the typed search term
...
//           children: [
//             // 3. Render the Search Bar widget directly at the top of the content body
//             const SizedBox(height: 12),
//             CustomSearchBar(
//               hintText: "Search courses...",
//               onChanged: (value) {
//                 setState(() {
//                   courseSearchQuery = value; // Live updates the screen layout
//                 });
//               },
//             ),
//             SizedBox(height: Responsive.spacing(context, 0.025)),

//             // 4. Handle core screen layout states inside the remaining screen area
//             Expanded(
...
//                           ),
//                         )
//                       : _buildCoursesList(context, filteredCourses),
//             ),
//           ],
//         ),
//       ),
